...
import { Modal, Button, Row, Form, Col, Space, Card, Image, Carousel } from "antd";
  ...
  return (
    ...
    >
      <Form className={"form"} layout="vertical">
        <Row gutter={16}>
          <Col span={12}>
            <Card className={"card-profile"} title={props.type == "compareStruct" ? "Genuine Store Struct" : "Struct Photo"}>
          ...
          <Col span={12}>
            <Card className={"card-profile"} title={props.type == "compareStruct" ? "Consumen Struct Photo" : "Indicate Duplicate Struct Photo"}>
              <Carousel afterChange={onChange}>
                {states.type == "compareStruct" ?  
                  states.url.map((item: any, idx: number) => (  
                    <Image 
