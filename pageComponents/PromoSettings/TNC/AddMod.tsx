        ...
        footer={
          <Space size={0}>
                    <Button onClick={() => handleSubmit({
                        id: Buffer.from(states.id ? states.id.toString() : '').toString("base64"),
                        title: Buffer.from(states.title).toString("base64"),
                        content: Buffer.from(states.content).toString("base64"),
                        type: Buffer.from(states.type.toString()).toString("base64")
                    })}>
                        Save
                    </Button>
              ...
              <Row>
                <Col span={24}>
                  <Form.Item label="Content">
                    ...
                    /> */}
                    <MDEditor height={400} value={states.content} onChange={(e) => handleChangeMD(e, 'content')} />
                  </Form.Item>
                </Col>
              </Row>
              <Row>
