...
import { save, modify, remove } from "../../api/promosettings/news/modify";
...
const ProcessMenu = (props: any) => {
    ...
    useEffect(() => {
        ...
        router.push('/promosettings/news')
    },[])
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    const trueRole = await pageCheck(session.username, '/promosettings/news')
