...
import { save, modify, remove } from "../../api/promosettings/banner/modify";
...
const ProcessMenu = (props: any) => {
    ...
    useEffect(() => {
        ...
        router.push('/promosettings/banner')
    },[])
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    const trueRole = await pageCheck(session.username, '/promosettings/banner')
