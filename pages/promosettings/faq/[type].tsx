...
import { save, modify, remove } from "@api/promosettings/faq/modify";
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    const trueRole = await pageCheck(session.username, '/promosettings/faq')
