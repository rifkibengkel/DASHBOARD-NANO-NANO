...
import { save, modify } from "../../api/promosettings/medias/modify";
...
const ProcessMenu = (props: any) => {
    ...
    useEffect(() => {
        ...
        router.push('/promosettings/media')
    },[])
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    const trueRole = await pageCheck(session.username, '/promosettings/media')
